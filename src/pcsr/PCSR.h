...
class PCSR {
 public:
  // data members
  edge_list_t edges;
  //vector<int> selected_hot_vertices;
  //int max_hot_vertex=0;
  //int balance_for_hot=0;
  //int balance_for_cold=0;
  //vector<bool> attached_pages;         //whether have been balanced

  PCSR(int, uint32_t init_n, uint32_t, bool lock_search, int domain = 0);
  ...
  //bool belonging_to_hot_vertex(int src);
  vector<int> get_neighbourhood(int src) const;
  int get_distance(int src, int dest);
  /**
